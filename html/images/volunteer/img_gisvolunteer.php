...
if ((!$xhr_latitude) || (!$xhr_longitude)) {
	...
	if (file_exists("/var/chroot/home/content/57/3881957/html/images/volunteer/".$xhr_latitude.$xhr_longitude.".gif")) {
		/*	image exists */
		// print image
		...
		// create image path
		$img_tms_path= "/var/chroot/home/content/57/3881957/html/images/volunteer/".$xhr_latitude.$xhr_longitude.".gif";
