...
<!--
/*
  Minimalistic by subBlue Design @ http://www.subBlue.com

  NOTE: These CSS definitions are also stored within the main page body so that you can use the phpBB2 theme administration centre. When you have finalised your style you could cut the final CSS code and place it in an external file, deleting this section to save bandwidth.
*/
...
-->
<body style="background-color:#c2c0c0;" text="{T_BODY_TEXT}" link="{T_BODY_LINK}" vlink="{T_BODY_VLINK}">

<a name="top"></a>

<!-- width="656" -->
<table width="764" height="100%" bgcolor="white" cellspacing="0" cellpadding="0" border="0" align="center"> 
	<tr valign="top">
		<td background="templates/Minimalistic/images/left.gif" width="3"></td>
		<td width="650">
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
				<tr> 
					<td align="center" width="100%" valign="middle"><br /><span class="maintitle">{SITENAME}</span><br /><span class="gen">{SITE_DESCRIPTION}</span><br /><br /><img src=" templates/Minimalistic/images/black.gif" height="1" width="100%" />
				</tr>
			</table>
