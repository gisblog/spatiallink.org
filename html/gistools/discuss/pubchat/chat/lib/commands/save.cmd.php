...
if ($Count != "0")
{
	...
	$jsTbl = array(
		...
		"window.open(\"export.php?L=$L&U=".urlencode(stripslashes($U))."&R=".urlencode(stripslashes($R))."&ST=$ST".$Save_URL_Query."\",\"save_popup\",\"width=0,height=0,scrollbars=no,resizable=no\");",
		"// -->",
		"</SCRIPT>"
	);
}
