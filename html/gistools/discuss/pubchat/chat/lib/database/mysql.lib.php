...
class DB
{
	var $Host = 'spatiallink.db.3881957.hostedresource.com';	// Hostname of our MySQL server
	var $Database = 'spatiallink';								// Logical database name on that server
	var $User = 'spatiallink';									// Database user
	var $Password = 'XSQLhvp246#';								// Database user's password
