...
$database =@mysql_pconnect($pdb->dbHostName,$pdb->userName,$pdb->userPassword);
            @mysql_select_db($pdb->dbName) or die( "Unable to select database");               

$result = mysql_list_tables($pdb->dbName);
