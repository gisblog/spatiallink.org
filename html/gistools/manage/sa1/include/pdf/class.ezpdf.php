...
function ezTable(&$data,$cols='',$title='',$options=''){
  ...
  if ($options['showHeadings']){
    ...
    if($options['shadeHeadings']){
    	 $this->closeObject();
     $this->setColor($options['headCol'][0],$options['headCol'][1],$options['headCol'][2],1);
     $this->filledRectangle($x0-$options['gap']/2 ,$y+$decender+$height- $headingHeight/2 - 2,$x1-$x0 - 1,$headingHeight - 1);
