 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Popup.php,v 1.36 2005/02/09 07:08:54 andrew Exp $
...
if($_REQUEST['form'] == 'EditView')
{
	...
	$button .= "<input title='".$app_strings['LBL_CLEAR_BUTTON_TITLE']."' accessKey='".$app_strings['LBL_CLEAR_BUTTON_KEY']."' class='button' LANGUAGE=javascript onclick=\"window.opener.document.EditView.account_name.value = '';window.opener.document.EditView.account_id.value = ''; window.close()\" type='submit' name='button' value='  Clear  '>\n";
...
elseif(isset($_REQUEST['form_submit']) && $_REQUEST['form'] == 'BugDetailView' && $_REQUEST['form_submit'] == 'true')
{
	...
	$the_javascript .= "	window.opener.document.DetailView.return_id.value = window.opener.document.DetailView.record.value; \n";
	$the_javascript .= "	window.opener.document.DetailView.module.value = 'Cases'; \n";
	$the_javascript .= "	window.opener.document.DetailView.action.value = 'SaveBugCaseRelationship'; \n";
	$the_javascript .= "	window.opener.document.DetailView.submit(); \n";
	$the_javascript .= "}\n";
	$the_javascript .= "</script>\n";
	$button  = "<form border='0' action='index.php' method='post' name='form' id='form'>\n";
...
}	else
{
	$the_javascript  = "<script type='text/javascript' language='JavaScript'>\n";
	$the_javascript .= "function set_return(case_id, case_name) {\n";
	$the_javascript .= "	window.opener.document.".$_REQUEST['form'].".parent_name.value = case_name;\n";
	$the_javascript .= "	window.opener.document.".$_REQUEST['form'].".parent_id.value = case_id;\n";
	$the_javascript .= "}\n";
	$the_javascript .= "</script>\n";
	$button  = "<form border='0' action='index.php' method='post' name='form' id='form'>\n";
