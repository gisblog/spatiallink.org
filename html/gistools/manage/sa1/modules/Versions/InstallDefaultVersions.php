 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /var/cvsroot/sugarcrm/modules/Versions/InstallDefaultVersions.php,v 1.2 2005/04/13 23:22:53 majed Exp $
 * Description:
 ********************************************************************************/
...
foreach($default_versions as $default_version){
	$version =& new Version();
	if($version->retrieve_by_string_fields(array('name'=>$default_version['name'])) == null){
