 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: ListView.php,v 1.51 2005/04/29 00:39:36 clint Exp $
...
if (!isset($_REQUEST['search_form']) || $_REQUEST['search_form'] != 'false') {
	...
	if(isset($_REQUEST['query'])) {
		...
		if(isset($_REQUEST['contact_name'])) $search_form->assign("CONTACT_NAME", to_html($_REQUEST['contact_name']));
		if(isset($current_user_only)) $search_form->assign("CURRENT_USER_ONLY", "checked");
	}
 // adding custom fields:
		$seedCall->custom_fields->populateXTPL($search_form, 'search' );
...
if(isset($_REQUEST['query']))
{
	...
	$seedCall->custom_fields->setWhereClauses($where_clauses);
