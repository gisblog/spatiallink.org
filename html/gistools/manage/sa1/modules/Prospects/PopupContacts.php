 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: PopupContacts.php,v 1.3 2005/04/20 00:16:42 joey Exp $
...
//	append_where_clause($where_clauses, "account_name", "contacts.account_name");
...
// Start the output
////////////////////////////////////////////////////////
$form =new XTemplate ('modules/Prospects/Popup_Contacts_picker.html');
$log->debug("using file modules/Prospects/Popup_Contacts_picker.html");
...
if($_REQUEST['form'] == 'ContactsForm')
{
	...
	$button .= "<input type=hidden name='action' value='SaveContactsRelationship'>\n";
...
$ListView->setQuery($where, "", "last_name", "CONTACT");
$ListView->setModStrings($current_module_strings);
$ListView->processListViewMulti($seed_object, "main", "CONTACT");
