 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: PopupProspects.php,v 1.4 2005/04/30 02:19:00 majed Exp $
...
// Start the output
////////////////////////////////////////////////////////
$form =new XTemplate ('modules/Prospects/Popup_Prospects_picker.html');
$log->debug("using file modules/Prospects/Popup_Prospects_picker.html");
...
if($_REQUEST['form'] == 'ProspectsForm')
{
	...
	$button .= "<input type=hidden name='action' value='SaveProspectsRelationship'>\n";
...
$ListView->setQuery($where, "", "last_name", "PROSPECT");
$ListView->setModStrings($current_module_strings);
$ListView->processListViewMulti($seed_object, "main", "PROSPECT");
