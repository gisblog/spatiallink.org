 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Popup.php,v 1.3 2005/02/09 07:08:54 andrew Exp $
...
else 
{
	$the_javascript  = "<script type='text/javascript' language='JavaScript'>\n";
	$the_javascript .= "function set_return(contact_id, contact_name) {\n";
	$the_javascript .= "	window.opener.document.".$_REQUEST['form'].".contact_name.value = contact_name;\n";
	$the_javascript .= "	window.opener.document.".$_REQUEST['form'].".contact_id.value = contact_id;\n";
	$the_javascript .= "}\n";
	$the_javascript .= "</script>\n";
	$button  = "<form action='index.php' method='post' name='form' id='form'>\n";
