 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Popup.php,v 1.36.2.1 2005/05/06 02:59:40 robert Exp $
...
else
{
	...
	$the_javascript  = "<script type='text/javascript' language='JavaScript'>\n";
	$the_javascript .= "function set_return(user_id, user_name) {\n";
	$the_javascript .= "	window.opener.document.EditView.{$parent_name_name}.value = user_name;\n";
	$the_javascript .= "	window.opener.document.EditView.{$parent_id_name}.value = user_id;\n";
	$the_javascript .= "}\n";
	$the_javascript .= "</script>\n";
}
...
$button  = "<table cellspacing='0' cellpadding='0' border='0' width='250'><form border='0' action='index.php' method='post' name='form' id='form'>\n";
$button .= "<tr>";
