 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Forms.php,v 1.20.2.1 2005/05/13 18:50:48 joey Exp $
...
if(typeof object_refs['hide_tabs'] != 'undefined')
{
	for(i=0; i < object_refs['hide_tabs'].options.length ;i++)
	{
         hide_tabs_def += "hide_tabs[]="+object_refs['hide_tabs'].options[i].value+"&";
	}
}

if(typeof object_refs['remove_tabs'] != 'undefined')
{
	for(i=0; i < object_refs['remove_tabs'].options.length ;i++)
	{
         remove_tabs_def += "remove_tabs[]="+object_refs['remove_tabs'].options[i].value+"&";
	}
