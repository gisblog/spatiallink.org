 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: ListView.php,v 1.52 2005/04/29 00:39:36 clint Exp $
...
if (!isset($_REQUEST['search_form']) || $_REQUEST['search_form'] != 'false') {
	...
	$seedMeeting->custom_fields->populateXTPL($search_form, 'search' );
...
if(isset($_REQUEST['query']))
{
	...
	$seedMeeting->custom_fields->setWhereClauses($where_clauses);
