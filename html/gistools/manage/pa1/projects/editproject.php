...
$copy = returnGlobal('copy','REQUEST');
...
//insert into projects and teams (with last id project)
		$tmpquery1 = "INSERT INTO ".$tableCollab["projects"]."(name,priority,description,owner,organization,status,created,published,upload_max,url_dev,url_prod,phase_set) VALUES('$pn','$pr','$d','$pown','$clod','$st','$dateheure','$projectPublished','$up','$url_dev','$url_prod','$thisPhase')";
...
//update project
		$tmpquery = "UPDATE ".$tableCollab["projects"]." SET name='$pn',priority='$pr',description='$d',url_dev='$url_dev',url_prod='$url_prod',owner='$pown',organization='$clod',status='$st',modified='$dateheure',upload_max='$up',phase_set='$thisPhase' WHERE id = '$id'";
		connectSql("$tmpquery");
//if mantis bug tracker enabled
	if ($enableMantis == "true") {
// call mantis function to copy project
...
//insert into projects and teams (with last id project)
		$tmpquery1 = "INSERT INTO ".$tableCollab["projects"]."(name,priority,description,owner,organization,status,created,published,upload_max,url_dev,url_prod,phase_set) VALUES('$pn','$pr','$d','$pown','$clod','$st','$dateheure','1','$up','$url_dev','$url_prod','$thisPhase')";
		connectSql("$tmpquery1");
		$tmpquery = $tableCollab["projects"];
		last_id($tmpquery);
		$num = $lastId[0];
...
if ($id != "") {
$block1->form = "epD";
$block1->openForm("../projects/editproject.php?id=$id&amp;action=update&amp;copy=$copy&amp;".session_name()."=".session_id()."#".$block1->form."Anchor");
