...
echo "<img src=\"graphtasks.php?".session_name()."=".session_id()."&amp;project=".$projectDetail->pro_id[0]."&amp;phase=".$phaseDetail->pha_order_num[0]."\" alt=\"\"><br>
...
$block2->paletteScript(2,"copy","../tasks/edittask.php?project=$project&amp;copy=true","false,true,false",$strings["copy"]);
