	...
	<td colspan="2" class="medium">
		...
		<div class="summary_visible">
			...
			include '/var/chroot/home/content/57/3881957/html/inc_con/rss/rss_blog.spatial.php';
			?>
				</tbody>
					</table>
		</div>
		...
		<div class="summary_visible">
			...
			// include rss_blog.sci_tech:
				include '/var/chroot/home/content/57/3881957/html/inc_con/rss/rss_blog.sci_tech.php';
			?>
				</tbody>
					</table>
		</div>
		...
		<div class="summary_visible">
			...
			include '/var/chroot/home/content/57/3881957/html/inc_con/rss/rss_blog.data.php';
			?>
				</tbody>
					</table>
		</div>
