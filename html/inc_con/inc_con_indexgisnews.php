	...
	<td class="medium_bold">
		<?php
		// include new
		//	include '/var/chroot/home/content/57/3881957/html/inc/inc_new.php';
		//	include store
		// include '/var/chroot/home/content/57/3881957/html/gistools/store/store_google_content.php';
		/*
		<style type="text/css">
		<!--
	...
	<td colspan="2" class="medium">
		...
		include '/var/chroot/home/content/57/3881957/html/scripts_fct/scr_fct_sort.php';
		?>
		&#8226;&nbsp;Spatial::
		<div class="summary_visible">
			...
			include '/var/chroot/home/content/57/3881957/html/inc_con/rss/rss_news.spatial.php';
			?>
				</tbody>
					</table>
		</div>
		...
		<div class="summary_visible">
			...
			// include rss_news.sci_tech:
				include '/var/chroot/home/content/57/3881957/html/inc_con/rss/rss_news.sci_tech.php';
			?>
				</tbody>
					</table>
		</div>
