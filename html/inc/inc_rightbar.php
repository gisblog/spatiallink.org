...
<td width="120" bgcolor="#dddddd" class="medium">
	<?php
	/*	URL/URI filter: 
		$REQUEST_URI ~ $PHP_SELF. note that PHP_SELF only returns the page url (page.php), whereas REQUEST_URI will also return the GET variables or $_SERVER['QUERY_STRING'] (page.php?x=y).	you can concatenate like so- 
				$pageurl = $PHP_SELF."?".$_SERVER['QUERY_STRING'];	*/
	if ($REQUEST_URI == "/poll/poll_voteresult.php") {
		...
		include '/var/chroot/home/content/57/3881957/html/poll/poll_variables.php'; 
		// done
