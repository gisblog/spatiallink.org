...
$img_suffix = rand(1,4);
$img = imagecreatefromgif("/opt/bitnami/apache2/htdocs/images/img_verification_back.".$img_suffix.".gif"); 
...
$img_output = "/opt/bitnami/apache2/htdocs/images/img_verification_code.".$img_suffix.".gif";
