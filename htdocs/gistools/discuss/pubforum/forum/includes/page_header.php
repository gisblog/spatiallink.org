...
// ...with
// 'T_BODY_VLINK' => '#581963',
/* embed: start. refer to inc_header.php */
/* require: first set environment etc */
require '/opt/bitnami/apache2/htdocs/inc/inc_environment.php';
require '/opt/bitnami/apache2/htdocs/inc/inc_access_deny.php';
?>
...
<div align="center">
	...
	<td bgcolor="#c2c0c0" class="medium">
		...
		<?php
		//	include headerflash	
		include '/opt/bitnami/apache2/htdocs/mmx/headerflash.php'; 
		?>
		</a>
		<span class="small">
		<?php
		...
		if (stristr($varbrowser, "MSIE")) {
			include '/opt/bitnami/apache2/htdocs/scripts/scr_addtofavorites.js'; 
	...
	<td bgcolor="#c2c0c0" class="medium_right_middle">
		<?php
		//	include search
		include '/opt/bitnami/apache2/htdocs/inc_con/inc_con_search.php';
		?>
		<a href="/">Home</a>
		 | 
		...
		<?php
		//	include script
		include '/opt/bitnami/apache2/htdocs/scripts/scr_popup_tos.js';
		?>
	...
	&nbsp;
		<?php
		//	include store
		include '/opt/bitnami/apache2/htdocs/gistools/store/store_google_header.php';
		?>
	</td>
		</tr>
		<tr>
	...
	<?php
	//	include menu_header
	include '/opt/bitnami/apache2/htdocs/scripts/menu/header/any/index.php';
	?>
	</td>
		</tr>
			</table>
