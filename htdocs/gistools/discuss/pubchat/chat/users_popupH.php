...
<CENTER>
	...
	<P>
		...
		&nbsp;
		<A HREF="users_popupH.php?<?php echo($ChangeBeeps_Reload); ?>"><IMG SRC="images/<?php if ($B == "0") echo("no"); ?>sound.gif" WIDTH=13 HEIGHT=13 ALIGN="MIDDLE" BORDER=0 ALT="<?php echo(L_BEEP); ?>"></A>
	</P>
</CENTER>
