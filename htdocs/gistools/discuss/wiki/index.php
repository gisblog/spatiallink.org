...
$key_dir = "/opt/bitnami/apache2/htdocs/gistools/discuss/wiki/wikikey/";
$history_dir = "/opt/bitnami/apache2/htdocs/gistools/discuss/wiki/wikihistory/";
...
if ($varstristrurl == $wiki_url_sub.$filename.$edit_true) {
	...
	if ($varstristrrefsite != $wiki_url_sub.$filename) {
		...
		include '/opt/bitnami/apache2/htdocs/inc/inc_stop.php';
	}
}
/*	ACCESS CHECK */
	...
	function editpage($file) {
			...
			if ((file_exists($key)) && (time()-filemtime($key) < 900)) {
				...
				//// include '/opt/bitnami/apache2/htdocs/scripts_xhr/scr_xhr_gethttpobject.js';
				//// include '/opt/bitnami/apache2/htdocs/scripts_xhr/scr_xhr_wiki_submit.js';
				?>
				...
				include '/opt/bitnami/apache2/htdocs/images/img_verification_code.php';
