...
<table width="95%" border="0" cellpadding="2" class="formPage">
  ...
  <tr>
    ...
    <td width="70%" class="smallDesc">
      ...
      <div id="dbUser" class="longDescription">The username used to connect to the database server. An example username is 'mysqli_10'.<br><br>Note: Create and Drop permissions <b>are not required</b> for the general use of osCommerce.</div>
    </td>
  </tr>
  <tr>
