...
if ($_SERVER['HTTP_REFERER'] == "http://www.spatiallink.org/gistools/volunteer/gisvolunteer_search.php") {
	...
	<!--clusterer-->
	<!--
	<script src="gisvolunteer_gmaps_clusterer.js" type="text/javascript">
	</script>
	-->
	<!--clusterer-->
			...
			request.onreadystatechange = function() {
			  if (request.readyState == 4) {
			    ...
			    for (var i = 0; i < markers.length; i++) {
				    ...
				    var marker = createMarker(point, "[" + markers[i].getAttribute("sn") + "] " + markers[i].getAttribute("jobtitle") + ", " + markers[i].getAttribute("country"));
				    //
