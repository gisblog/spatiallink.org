 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: SubPanelViewProspects.php,v 1.6 2005/04/20 00:16:42 joey Exp $
...
$button  = "<form action='index.php' method='post' name='ProspectsForm' id='ProspectsForm'>\n";
$button .= "<input type='hidden' name='module' value='Prospects'>\n";
...
if ($currentModule == 'ProspectLists') 
	$button .= "<input title='".$app_strings['LBL_SELECT_BUTTON_TITLE']." 'accessyKey='".$app_strings['LBL_SELECT_BUTTON_KEY']."' type='button' class='button' value='  ".$app_strings['LBL_SELECT_BUTTON_LABEL']."  ' name='button' LANGUAGE=javascript onclick='window.open(\"index.php?module=Prospects&action=PopupProspects&html=Popup_Prospects_picker&form=ProspectsForm&record=".$focus->id."&form_submit=true&query=true\",\"new\",\"width=600,height=400,resizable=1,scrollbars=1\");'>\n";
...
$ListView->initNewXTemplate('modules/Prospects/SubPanelViewProspects.html', $current_module_strings);

$ListView->xTemplateAssign("PROSPECT_LIST_RECORD", $focus->id);
...
$ListView->setQuery("", "", "last_name", "PROSPECT");
$ListView->setHeaderText($button);
$ListView->processListView($focus_list, "main", "PROSPECT");
