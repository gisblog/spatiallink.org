 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: ContactBugRelationshipEdit.php,v 1.3 2005/02/09 07:08:54 andrew Exp $
...
$log->info("Contact bug relationship");
...
echo "\n<p>\n";
echo get_module_title($mod_strings['LBL_MODULE_NAME'], $mod_strings['LBL_CONTACT_BUG_TITLE']." ".$contactName['NAME'] . " - ". $bugName['NAME'], true);
echo "\n</p>\n";
