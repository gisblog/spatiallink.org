...
$mod_strings = array (
  ...
  'NTC_DELETE_CONFIRMATION' => 'Are you sure you want to delete this record? It may be better to set the status to inactive otherwise any record using this currency will be converted to U.S. Dollars when they are acceessed.',
  'currency_status_dom' => 
  array (
    'Active' => 'Active',
    'Inactive' => 'Inactive',
