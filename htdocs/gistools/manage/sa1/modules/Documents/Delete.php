 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Delete.php,v 1.4 2005/04/29 20:56:43 ajay Exp $
...
$log = LoggerManager::getLogger('document_revision_delete');
...
if (isset($_REQUEST['object']) && $_REQUEST['object']="documentrevision") {
	...
	if (!empty($revisions) && is_array($revisions)) {
		foreach($revisions as $key=>$thisversion) {
			...
			$thisversion->mark_deleted($thisversion->revision_id);
		}				
	}
}
