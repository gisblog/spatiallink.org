...
/*
$Id: nusoap.php,v 1.3 2004/09/04 20:03:32 sugarclint Exp $
...
* @version  $Id: nusoap.php,v 1.3 2004/09/04 20:03:32 sugarclint Exp $
* @access   public
*/
class nusoap_base {
...
//$log->fatal("in processing section: $data");			
			
			// handle the request
			$this->parse_request($data);
			if (! $this->fault) {
//$log->fatal("Request has been parsed");				
				$this->invoke_method();
			}
			if (! $this->fault) {
