...
<tr>
<td class="dataLabel">
<h4 class="dataLabel"><?php echo $this->args['title']; ?></h4>
</td>
</tr>
<tr>
<td>
...
<tr>
	<td>&nbsp;</td>
	<td  class="dataLabel" id="chooser_<?php echo $this->args['left_name'];?>_text"><nobr><b><?php echo $this->args['left_label']; ?></b></nobr></td>
	<?php if ($this->display_hide_tabs==true) {?>
	<td>&nbsp;</td>
	<td  class="dataLabel" id="chooser_<?php echo $this->args['right_name'];?>"><nobr><b><?php echo $this->args['right_label']; ?></b></nobr></td>
	<?php } ?>
	<?php if ($this->display_third_tabs==true) {?>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td  class="dataLabel" id="chooser_<?php echo $this->args['third_name'];?>"><nobr><b><?php echo $this->args['third_label']; ?></b></nobr></td>
	<?php } ?>
</tr>
<tr>
...
<a onclick="javascript:up('<?php echo $this->args['left_name'];?>');"><?php echo get_image($image_path.'uparrow_big','border="0" style="margin-bottom: 1px;" alt="Sort"');?></a><br>
<a onclick="javascript:down('<?php echo $this->args['left_name'];?>');"><?php echo get_image($image_path.'downarrow_big','border="0" style="margin-top: 1px;"  alt="Sort"');?></a>
<?Php } ?>
			</td>
	...
	<td>
		...
		<table border="0" cellspacing=0 cellpadding="0">
		<tr>
			<td id="<?php echo $this->args['left_name'];?>_td">
...
<?php } ?>
	...
	<td id="<?php echo $this->args['right_name']; ?>_td">
...
<?php } ?>
	...
	<td id="<?php echo $this->args['third_name']; ?>_td">
