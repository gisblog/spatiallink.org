...
$help["setup_loginmethod"] = "Zpùsob uložení hesla v databázi.<br>Set to &quot;Crypt&quot; in order CVS authentication and htaccess authentification to work (if CVS support and/or htaccess authentification are enabled).";
