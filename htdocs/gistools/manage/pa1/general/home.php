...
//if mantis bug tracker enabled
	if ($enableMantis == "true") {
		$block1->paletteScript(8,"bug",$pathMantis."login.php?url=http://{$HTTP_HOST}{$_SERVER['REQUEST_URI']}&f_username=$loginSession&f_password=$passwordSession","false,true,false",$strings["bug"]);
	}
