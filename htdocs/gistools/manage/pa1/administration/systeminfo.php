...
if ($databaseType == "mysql") {
	...
	$link = mysqli_connect(MYSERVER,MYLOGIN,MYPASSWORD) or die("Connection impossible");
	$local_query = "SELECT VERSION() as version";
	$res = mysqli_query($varconnect, $local_query,$link);
	$databaseVersion = mysqli_result($res, 0, 'version');
}
