...
if ($idSession == $projectDetail->pro_owner[0] || $profilSession == "0" || $profilSession == "5") {
	...
	$block1->paletteScript(1,"copy","../projects/editproject.php?id=".$projectDetail->pro_id[0]."&amp;copy=true","true,true,false",$strings["copy"]);
	...
	$block1->paletteScript(3,"edit","../projects/editproject.php?id=".$projectDetail->pro_id[0]."&amp;copy=false","true,true,false",$strings["edit"]);
}
if ($enable_cvs == "true") {
	$block1->paletteScript(4,"cvs","../browsecvs/browsecvs.php?id=$id","true,true,false",$strings["browse_cvs"]);
}
if ($enableMantis == "true") {
	$block1->paletteScript(5,"bug",$pathMantis."login.php?id=".$projectDetail->pro_id[0]."&url=http://{$HTTP_HOST}{$_SERVER['REQUEST_URI']}&f_username=$loginSession&f_password=$passwordSession","true,true,false",$strings["bug"]);
}
...
echo "<img src=\"../tasks/graphtasks.php?".session_name()."=".session_id()."&amp;project=".$projectDetail->pro_id[0]."\" alt=\"\"><br>
...
$block2->paletteScript(2,"copy","../tasks/edittask.php?project=".$projectDetail->pro_id[0]."&amp;copy=true","false,true,false",$strings["copy"]);
