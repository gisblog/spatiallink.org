...
if (isset($_POST['qsearchkeywords']) && $_SERVER['HTTP_REFERER'] == "http://www.spatiallink.org/") {
	...
	include '/opt/bitnami/apache2/htdocs/inc_con/inc_con_indexed.php';
} else {
	...
	<td width="520" class="medium">
		...
		$result = mysqli_query($varconnect, $query) or die("Operation Failure :" . mysqli_error($varconnect));
		while ($row = mysqli_fetch_array($result)) {
			...
			//	include code2state
			include '/opt/bitnami/apache2/htdocs/inc/inc_code2state.php';
		}
		//
		print 'and ';
		//
		...
		include '/opt/bitnami/apache2/htdocs/inc_con/inc_con_gisvolunteer_sampleprofile.php';
		?>
		<br />
		<br /> 
		<?php
		...
		<center>	
			...
			<?php
			//	include script
			include '/opt/bitnami/apache2/htdocs/inc_con/inc_con_index_disclaimer.php';
			print "<br /><br />";
			//	include board
			//	include '/opt/bitnami/apache2/htdocs/inc_con/inc_con_index_board.php';
			?>
		</center>				
	</td>
	<td width="120">
