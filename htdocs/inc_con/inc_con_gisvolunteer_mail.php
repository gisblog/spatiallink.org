...
if ($_SERVER['HTTP_REFERER'] == "http://www.spatiallink.org/gistools/volunteer/gisvolunteer_search.php") {
	...
	$result6 = mysqli_query($varconnect, $query6) or die("Operation Failure :".mysqli_error($varconnect));
	...
	if ($num_rows == 1) {
		...
		//	job [13] variables from text file
			$filehandle1 = fopen("/opt/bitnami/apache2/htdocs/txt/volunteer/automail_".$email."_".$varip.".txt", "r");
