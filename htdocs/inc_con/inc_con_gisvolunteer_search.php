...
if ($_SERVER['HTTP_REFERER'] == "http://www.spatiallink.org/gistools/volunteer/gisvolunteer_search.php") {
	require '/opt/bitnami/apache2/htdocs/inc_con/inc_con_gisvolunteer_searched.php';
// done
} else {
	?>
	...
	<!--include cell table: layout. class needs to be defined for every cell table or else IE will NOT render correctly-->
		...
		<?php
		// include cell table
		include '/opt/bitnami/apache2/htdocs/inc_con/inc_con_gisvolunteer_searchtable.php';
		?>
		</td>
		<td class="medium">
