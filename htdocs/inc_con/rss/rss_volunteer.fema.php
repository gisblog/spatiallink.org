...
/* 1 */
	...
	$rss = fetch_rss('http://www.fema.gov/news/disasters_rss.fema');
	if ($rss) {
		...
		foreach ($items as $item )
		{
			...
			print '&#186;&nbsp;<a href="'.htmlentities($item['link']).'" onmouseover="return overlib(\''.fct_cleanstring($item['description']).'\');" onmouseout="return nd();">'.htmlentities($item['title']).' - FEMA</a><br />';
			// done
		}
	} else {
